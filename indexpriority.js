...
app.post("/financialcalculation", async (req, res) => {
  ...
  async function Calculation(topology, dateupload) {
    ...
    tx(initsc[0], finalsc[0], realsc[0], initialprice[0], finalprice[0], nonce, newArray[0], feeData)
    tx(initsc[1], finalsc[1], realsc[1], initialprice[1], finalprice[1], (nonce+1), newArray[1], feeData)
    tx(initsc[2], finalsc[2], realsc[2], initialprice[2], finalprice[2], (nonce+2), newArray[2], feeData)
    tx(initsc[3], finalsc[3], realsc[3], initialprice[3], finalprice[3], (nonce+3), newArray[3], feeData)
    tx(initsc[4], finalsc[4], realsc[4], initialprice[4], finalprice[4], (nonce+4), newArray[4], feeData)
    tx(initsc[5], finalsc[5], realsc[5], initialprice[5], finalprice[5], (nonce+5), newArray[5], feeData)
    tx(initsc[6], finalsc[6], realsc[6], initialprice[6], finalprice[6], (nonce+6), newArray[6], feeData)
    tx(initsc[7], finalsc[7], realsc[7], initialprice[7], finalprice[7], (nonce+7), newArray[7], feeData)
    tx(initsc[8], finalsc[8], realsc[8], initialprice[8], finalprice[8], (nonce+8), newArray[8], feeData)
    tx(initsc[9], finalsc[9], realsc[9], initialprice[9], finalprice[9], (nonce+9), newArray[9], feeData)
    tx(initsc[10], finalsc[10], realsc[10], initialprice[10], finalprice[10], (nonce+10), newArray[10], feeData)
    tx(initsc[11], finalsc[11], realsc[11], initialprice[11], finalprice[11], (nonce+11), newArray[11], feeData)
    tx(initsc[12], finalsc[12], realsc[12], initialprice[12], finalprice[12], (nonce+12), newArray[12], feeData)
    tx(initsc[13], finalsc[13], realsc[13], initialprice[13], finalprice[13], (nonce+13), newArray[13], feeData)
    tx(initsc[14], finalsc[14], realsc[14], initialprice[14], finalprice[14], (nonce+14), newArray[14], feeData)
    tx(initsc[15], finalsc[15], realsc[15], initialprice[15], finalprice[15], (nonce+15), newArray[15], feeData)
    tx(initsc[16], finalsc[16], realsc[16], initialprice[16], finalprice[16], (nonce+16), newArray[16], feeData)
    tx(initsc[17], finalsc[17], realsc[17], initialprice[17], finalprice[17], (nonce+17), newArray[17], feeData)
    tx(initsc[18], finalsc[18], realsc[18], initialprice[18], finalprice[18], (nonce+18), newArray[18], feeData)
    tx(initsc[19], finalsc[19], realsc[19], initialprice[19], finalprice[19], (nonce+19), newArray[19], feeData)
    tx(initsc[20], finalsc[20], realsc[20], initialprice[20], finalprice[20], (nonce+20), newArray[20], feeData)
    tx(initsc[21], finalsc[21], realsc[21], initialprice[21], finalprice[21], (nonce+21), newArray[21], feeData)
    tx(initsc[22], finalsc[22], realsc[22], initialprice[22], finalprice[22], (nonce+22), newArray[22], feeData)
    tx(initsc[23], finalsc[23], realsc[23], initialprice[23], finalprice[23], (nonce+23), newArray[23], feeData)
    await tx(initsc[24], finalsc[24], realsc[24], initialprice[24], finalprice[24], (nonce+24), newArray[24], feeData)
  ...
  async function tx(initsc, finalsc, realsc, initialprice, finalprice, nonce, house, feeData) {
